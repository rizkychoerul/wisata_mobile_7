...
class KulinerDescription extends StatefulWidget {
  const KulinerDescription({super.key});

  @override
  State<KulinerDescription> createState() => _KulinerDescriptionState();
}

class _KulinerDescriptionState extends State<KulinerDescription> {
